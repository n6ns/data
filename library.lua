...
do
	...
	function Library:Notification(message, duration, color, position)
		...
		local Shadow = Instance.new('TextLabel', Background)
		...
		Background.BackgroundColor3 = Color3.fromRGB(24, 25, 27)
		...
		Shadow.TextSize = Library.FSize
		table.insert(notification.Objects, Shadow)
		--
		Accent.Name = "Accent"
		Accent.Position = UDim2.new(0,0,0,0)
		Accent.Size = UDim2.new(0,1,1,0)
		Accent.BackgroundColor3 = Color3.new(1,0,0)
		...
		task.spawn(function()
			...
			local Tween1 = game:GetService("TweenService"):Create(Background, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {AnchorPoint = Vector2.new(0,0)}):Play()

			task.wait(duration)
			game:GetService("TweenService"):Create(Background, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut), {AnchorPoint = Vector2.new(1,0)}):Play()
			for i,v in next, notification.Objects do
				game:GetService("TweenService"):Create(v, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
			end
			game:GetService("TweenService"):Create(TextLabel, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
			game:GetService("TweenService"):Create(Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
		end)
		...
		NotifContainer.Position = UDim2.new(0,Position.X,0,Position.Y + (table.find(Library.Notifs, notification) * 20))
		NotifContainer.Size = UDim2.new(0,TextLabel.TextBounds.X + 5,0,16)
		Library:updateNotifsPositions(position)
	...
	do
		...
		function Library:Window(Options)
			local Window = {
				...
				Status = Options.status or Options.Status or "";
			};
			--
			...
			--
			local Path = game:GetService("RunService"):IsStudio() and game:GetService("Players").LocalPlayer.PlayerGui or game.CoreGui
			--
			DMT.Name = "DMT"
			DMT.Parent = Path
			...
			TitleShadow.FontFace  = Library.font
			...
			StatusShadow.FontFace  = Library.font
		...
		function Library:Page(Properties)
			...
			NewPage.FontFace  = Library.font
			NewPage.Text = ""
			NewPage.TextColor3 = Color3.fromRGB(245, 245, 245)
			NewPage.TextSize = Library.FSize
			NewPage.ZIndex = 5
			...
			PageNameShadow.FontFace  = Library.font
		...
		--
		function Pages:Preview(Properties)
			if not Properties then
				Properties = {}
			end
			--
			local Preview = {
				Window = self,
				Name = Properties.name or "esp preview",
				Elements = {},
				Content = {},
			}
			--
			...
			Outline.Name = "Outline"
			Outline.Parent = Preview.Window.Elements.RealPage
			Outline.BorderSizePixel = 0
			Outline.Size = UDim2.new(0, 300, 0, 400)
			Outline.Position = UDim2.new(1, 15, 0, -40)
			...
			Image.Size = UDim2.new(1,-40,1,-1)
			Image.Position = UDim2.new(0,20,0,-18)
			Image.Image = "http://www.roblox.com/asset/?id=89444105874401"
			Image.ScaleType = Enum.ScaleType.Fit
			
			local Hold = Instance.new("Frame", Inline)
			Hold.BackgroundTransparency = 1
			Hold.Parent = Inline
			Hold.BorderSizePixel = 0
			Hold.Size = UDim2.new(1,-80,1,-98)
			Hold.Position = UDim2.new(0,40,0,48)
			--Hold.Visible = false

			local BoxHolder = Instance.new("Frame", Hold)
			BoxHolder.BackgroundTransparency = 1
			BoxHolder.Size = UDim2.new(1,0,1,0)
			BoxHolder.ZIndex = 100
			
			local Frame2 = Instance.new("Frame", Hold) -- boxfill
			Frame2.BorderSizePixel = 0
			Frame2.Size = UDim2.new(1,6,1,6)
			Frame2.Position = UDim2.new(0,-3,0,-3)
			Frame2.ZIndex = 99
			
			local Frame3 = Instance.new("Frame",BoxHolder)
			Frame3.BackgroundTransparency = 1
			Frame3.Size = UDim2.new(1,2,1,2)
			Frame3.Position = UDim2.new(0,-1,0,-1)
			
			local UIStroke1 = Instance.new("UIStroke",BoxHolder)
			...
			local Frame3 = Instance.new("Frame",Hold) -- helth outline
			Frame3.BackgroundTransparency = 0
			Frame3.BorderSizePixel = 0
			Frame3.BackgroundColor3 = Color3.new(0,0,0)
			Frame3.Size = UDim2.new(0,3,1,6)
			Frame3.Position = UDim2.new(0,-7,0,-3)

			local Frame4 = Instance.new("Frame",Frame3) -- inline health
			Frame4.BackgroundTransparency = 0
			Frame4.BorderSizePixel = 0
			Frame4.AnchorPoint = Vector2.new(0,1)
			Frame4.BackgroundColor3 = Color3.new(0,1,0)
			Frame4.Size = UDim2.new(1,-2,1,-2)
			Frame4.Position = UDim2.new(0,1,1,-1)
			
			local TextLabel1 = Instance.new("TextLabel",Frame4)
			TextLabel1.BackgroundTransparency = 1
			TextLabel1.Position = UDim2.new(0,-5,0,0)
			TextLabel1.Size = UDim2.new(0,3,0,0)
			TextLabel1.FontFace  = Library.font
			--TextLabel1.TextTransparency = 0
			TextLabel1.Text = ""
			TextLabel1.TextColor3 = Color3.new(1, 1, 1)
			TextLabel1.TextSize = Library.FSize
			TextLabel1.TextXAlignment = Enum.TextXAlignment.Right
			
			local TextLabel2 = Instance.new("TextLabel",Hold)
			TextLabel2.BackgroundTransparency = 1
			TextLabel2.Position = UDim2.new(0,-3,0,-15)
			TextLabel2.Size = UDim2.new(1,6,0,12)
			TextLabel2.FontFace  = Library.font
			TextLabel2.Text = "Player-2735"
			TextLabel2.TextColor3 = Color3.new(1, 1, 1)
			TextLabel2.TextSize = Library.FSize
			TextLabel2.TextXAlignment = Enum.TextXAlignment.Center

			local TextLabel3 = Instance.new("TextLabel",Hold)
			TextLabel3.BackgroundTransparency = 1
			TextLabel3.Position = UDim2.new(0,-3,1,3)
			TextLabel3.Size = UDim2.new(1,6,0,12)
			TextLabel3.FontFace  = Library.font
			TextLabel3.Text = "K2"
			TextLabel3.TextColor3 = Color3.new(1, 1, 1)
			TextLabel3.TextSize = Library.FSize
			TextLabel3.TextXAlignment = Enum.TextXAlignment.Center

			local TextLabel4 = Instance.new("TextLabel",Hold)
			TextLabel4.BackgroundTransparency = 1
			TextLabel4.Position = UDim2.new(0,-3,1,18)
			TextLabel4.Size = UDim2.new(1,6,0,12)
			TextLabel4.FontFace  = Library.font
			TextLabel4.Text = "10m"
			TextLabel4.TextColor3 = Color3.new(1, 1, 1)
			TextLabel4.TextSize = Library.FSize
			TextLabel4.TextXAlignment = Enum.TextXAlignment.Center

			local TextLabel5 = Instance.new("TextLabel",Hold)
			TextLabel5.BackgroundTransparency = 1
			TextLabel5.Position = UDim2.new(1,5,0,-6)
			TextLabel5.Size = UDim2.new(0,0,0,12)
			TextLabel5.FontFace  = Library.font
			TextLabel5.Text = "Flags\n"
			TextLabel5.TextColor3 = Color3.new(1, 1, 1)
			TextLabel5.TextSize = Library.FSize
			TextLabel5.TextXAlignment = Enum.TextXAlignment.Left
			TextLabel5.TextYAlignment = Enum.TextYAlignment.Top

			
			game:GetService("RunService").RenderStepped:Connect(function()
				if TextLabel1.Visible == true then
					if Frame3.Visible == true then
						local f4 = Frame4.AbsoluteSize.Y
						local f3 = Frame3.AbsoluteSize.Y - 2  -- originally rounded to 3 ?
						
						TextLabel1.Text = math.floor((f4 / f3) * 100)
					end
				end
			end)
			
			function Preview:SetProp(obj, bool, prop)
				obj[prop] = bool
			end
			...
			Preview.Elements = {
				Boxfill = Frame2;
				Healthbar = Frame3;
				Healthbarinline = Frame4;
				Healthnumber = TextLabel1;
				Box = BoxHolder;
				Boxinline = UIStroke2;
				Flags = TextLabel5;
				Name = TextLabel2;
			...
			local function tweenhp()
				local duration = 3
				local min = UDim2.new(1, -2, 0, 0)
				local max = UDim2.new(1, -2, 1, -2)

				local Tween1 = game:GetService("TweenService"):Create(Frame4, TweenInfo.new(duration, Enum.EasingStyle.Linear), {Size = min})
				local Tween2 = game:GetService("TweenService"):Create(Frame4, TweenInfo.new(duration, Enum.EasingStyle.Linear), {Size = max})
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				HoldShadow.FontFace  = Library.font
				...
				ToggleShadow.FontFace  = Library.font
				...
				AlwaysShadow.FontFace  = Library.font
				...
				ValueShadow.FontFace  = Library.font
		...
		function Sections:Slider(Properties)
			...
			Slide.FontFace  = Library.font
			Slide.Text = ""
			Slide.TextColor3 = Color3.fromRGB(0, 0, 0)
			Slide.TextSize = Library.FSize
			...
			local function Set(value)
				...
				if Slider.Disabled and value == Slider.Disabled[2] and type(Slider.Disabled) == "table" then
					...
					ValueShadow.Text = Slider.Disabled[1]
				else
		...
		function Sections:List(Properties)
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					OptionShadow.FontFace  = Library.font
		...
		function Sections:Button(Properties)
			...
			function Button:Button(Properties)
				...
				iValueShadow.FontFace  = Library.font
